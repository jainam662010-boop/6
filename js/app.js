  ...
  const render=()=>{
    if(step===1){
      el.innerHTML=`<div class="wall-card ob-step">
        ...
        <div class="wall-title">Welcome to Vidya Mandir</div>
        <div class="wall-sub">Your complete Class 10 learning companion. Quick setup — 10 seconds.</div>
...
navbarHTML(){
  ...
  return`<nav class="topnav" id="mainNav">
    ...
    <a href="index.html" class="nav-brand"><div class="nav-gem">V</div><div class="nav-wordmark"><span class="nav-title">${site}</span><span class="nav-sub">Class 10 · CBSE</span></div></a>
